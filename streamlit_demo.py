...
os.environ["ALL_PROXY"] = "http://zs-165-225-226-44.gateway.zscloud.net:80"
os.environ["HTTP_PROXY"] = "http://zs-165-225-226-44.gateway.zscloud.net:80"
os.environ["HTTPS_PROXY"] = "http://zs-165-225-226-44.gateway.zscloud.net:80"

os.environ["REQUESTS_CA_BUNDLE"] = "./metrotrains.crt"
...
st.header("Welcome to the Llama Index ChatGPT")
